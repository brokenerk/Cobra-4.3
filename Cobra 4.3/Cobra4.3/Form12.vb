...
Public Class FrmNuevo
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Select Case op
            Case 1, 9, 17
                Documento = MSWord.Documents.Open("C:\Program Files (x86)\UPIS\UPIS Seguimientos.docx")
            ...
            Case 3, 11, 19
                Documento = MSWord.Documents.Open("C:\Users\Cesarin\UPIS\UPIS Seguimientos.docx")
            ...
            Case 8, 16, 24
                ...
                MsgBox("El Archivo se ha generado Exitosamente")
                Documento.SaveAs("Control de Solicitud")
                MSWord.Visible = True
        End Select
