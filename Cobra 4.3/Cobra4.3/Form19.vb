...
Imports System.IO
Public Class FrmMensual
    Private conexion As String
    Private Sub FrmMensual_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Cargar()
    ...
    Private Sub CboLugar_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CboLugar.SelectedIndexChanged
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Documento = MSWord.Documents.Open("C:\Program Files (x86)\UPIS\Informe-mensual.docx")
        Documento.Bookmarks.Item("Mes").Range.Text = CboMes.Text
        Documento.Bookmarks.Item("Año").Range.Text = CboAño.Text
        ...
        Documento.SaveAs("Informe Mes " + CboMes.Text)
        MSWord.Visible = True
